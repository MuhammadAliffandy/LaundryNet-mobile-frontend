...
class SalaryTransactionHistoryJoinView extends StatefulWidget {
  static const routeName = '/salary-transaction-history-join-screen';

  const SalaryTransactionHistoryJoinView({super.key});

  @override
  State<SalaryTransactionHistoryJoinView> createState() => _SalaryTransactionHistoryJoinViewState();
}

class _SalaryTransactionHistoryJoinViewState extends State<SalaryTransactionHistoryJoinView> {
  @override
