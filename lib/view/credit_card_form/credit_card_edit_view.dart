...
class CreditCardEditView extends StatefulWidget {
  static const routeName = '/credit-card-edit-screen';

  const CreditCardEditView({super.key});

  @override
  State<CreditCardEditView> createState() => _CreditCardEditViewState();
}

class _CreditCardEditViewState extends State<CreditCardEditView> {
  bool isCheck = false;
