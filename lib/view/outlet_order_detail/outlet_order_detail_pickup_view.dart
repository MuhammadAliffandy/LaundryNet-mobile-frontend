...
class OutletOrderDetailPickupView extends StatefulWidget {
  static const viewAsCustomer = '/outlet-order-detail-pickup-screen';

  const OutletOrderDetailPickupView({super.key});

  @override
  State<OutletOrderDetailPickupView> createState() => _OutletOrderDetailPickupViewState();
}

class _OutletOrderDetailPickupViewState extends State<OutletOrderDetailPickupView> {
