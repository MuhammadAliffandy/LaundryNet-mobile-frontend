...
class OutletOrderDetailCashierView extends StatefulWidget {
  static const viewAsEmployee = '/outlet-order-detail-Cashier-screen';

  const OutletOrderDetailCashierView({super.key});

  @override
  State<OutletOrderDetailCashierView> createState() => _OutletOrderDetailCashierViewState();
}

class _OutletOrderDetailCashierViewState extends State<OutletOrderDetailCashierView> {
