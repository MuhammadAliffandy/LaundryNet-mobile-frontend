...
class OutletOrderDetailFinishView extends StatefulWidget {
  static const viewAsCustomer = '/outlet-order-detail-finish-screen';

  const OutletOrderDetailFinishView({super.key});

  @override
  State<OutletOrderDetailFinishView> createState() => _OutletOrderDetailFinishViewState();
}

class _OutletOrderDetailFinishViewState extends State<OutletOrderDetailFinishView> {
