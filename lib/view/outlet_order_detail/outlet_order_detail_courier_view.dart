...
class OutletOrderDetailCourierView extends StatefulWidget {
  static const viewAsEmployee = '/outlet-order-detail-Courier-screen';

  const OutletOrderDetailCourierView({super.key});

  @override
  State<OutletOrderDetailCourierView> createState() => _OutletOrderDetailCourierViewState();
}

class _OutletOrderDetailCourierViewState extends State<OutletOrderDetailCourierView> {
        ...
        ...List.generate(3, (index) {
          return Padding(
            ...
            child: ItemCardListSelected(
              ...
              iconHeartColor: AppColors.white,
              boxShadow: const [
                BoxShadow(
                  color: AppColors.blackLv7,
                  offset: Offset(0, 4),
