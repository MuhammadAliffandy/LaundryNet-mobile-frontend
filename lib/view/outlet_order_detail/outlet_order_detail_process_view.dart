...
class OutletOrderDetailProcessView extends StatefulWidget {
  static const viewAsCustomer = '/outlet-order-detail-process-screen';

  const OutletOrderDetailProcessView({super.key});

  @override
  State<OutletOrderDetailProcessView> createState() => _OutletOrderDetailProcessViewState();
}

class _OutletOrderDetailProcessViewState extends State<OutletOrderDetailProcessView> {
  @override
