...
class OutletOrderDetailProductionView extends StatefulWidget {
  static const viewAsEmployee = '/outlet-order-detail-production-screen';

  const OutletOrderDetailProductionView({super.key});

  @override
  State<OutletOrderDetailProductionView> createState() => _OutletOrderDetailProductionViewState();
}

class _OutletOrderDetailProductionViewState extends State<OutletOrderDetailProductionView> {
        ...
        moreWidget: [
          AppColumnInk(
            children: [
              AppButton(
                rounded: true,
                buttonColor: AppColors.greenLv1,
                text: 'Telah Packing Semua Item',
                onTap: () {
                  // TODO
                },
              ),
