...
class ComplainDetailCustomerView extends StatefulWidget {
  static const viewAsCustomer = '/complain-detail-customer-screen';

  const ComplainDetailCustomerView({super.key});

  @override
  State<ComplainDetailCustomerView> createState() => _ComplainDetailCustomerViewState();
}

ScrollController? _controller;

class _ComplainDetailCustomerViewState extends State<ComplainDetailCustomerView> {
  @override
  void initState() {
