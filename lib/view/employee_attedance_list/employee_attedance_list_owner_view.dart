...
class EmployeeAttedanceListOwnerView extends StatefulWidget {
  static const viewAsOwner = '/employee-attedance-list-owner-screen';

  const EmployeeAttedanceListOwnerView({super.key});

  @override
  State<EmployeeAttedanceListOwnerView> createState() => _EmployeeAttedanceListOwnerViewState();
}

class _EmployeeAttedanceListOwnerViewState extends State<EmployeeAttedanceListOwnerView> {
  @override
