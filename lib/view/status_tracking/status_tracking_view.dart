...
class StatusTrackingView extends StatefulWidget {
  const StatusTrackingView({
    super.key,
  });

  static const routeName = '/status-tracking-screen';

  @override
  State<StatusTrackingView> createState() => _StatusTrackingViewState();
}

class _StatusTrackingViewState extends State<StatusTrackingView> {
