...
class PlatformWalletView extends StatefulWidget {
  static const routeName = '/platform-wallet-screen';

  const PlatformWalletView({super.key});

  @override
  State<PlatformWalletView> createState() => _PlatformWalletViewState();
}

class _PlatformWalletViewState extends State<PlatformWalletView> {
  @override
