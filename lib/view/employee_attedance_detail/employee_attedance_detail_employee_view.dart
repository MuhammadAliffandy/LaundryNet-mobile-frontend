...
class EmployeeAttedanceDetailEmployeeView extends StatefulWidget {
  static const viewAsEmployee = '/employee-attedance-detail-employee-screen';

  const EmployeeAttedanceDetailEmployeeView({super.key});

  @override
  State<EmployeeAttedanceDetailEmployeeView> createState() => _EmployeeAttedanceDetailEmployeeViewState();
}

class _EmployeeAttedanceDetailEmployeeViewState extends State<EmployeeAttedanceDetailEmployeeView> {
