...
class ComplainDiscussionJoinView extends StatefulWidget {
  static const routeName = '/complain-discussion-join-screen';

  const ComplainDiscussionJoinView({
    super.key,
  });

  @override
  State<ComplainDiscussionJoinView> createState() => _ComplainDiscussionJoinViewState();
}
...
class _ComplainDiscussionJoinViewState extends State<ComplainDiscussionJoinView> {
  @override
