...
class OperasionalOwner extends StatefulWidget {
  @override
  State<OperasionalOwner> createState() => _OperasionalOwnerState();
}

class _OperasionalOwnerState extends State<OperasionalOwner> {
  @override
