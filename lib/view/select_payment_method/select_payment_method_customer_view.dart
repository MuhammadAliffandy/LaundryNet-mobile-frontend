...
class SelectPaymentMethodCustomerView extends StatefulWidget {
  static const viewAsCustomer = '/select-payment-method-customer-screen';

  const SelectPaymentMethodCustomerView({super.key});

  @override
  State<SelectPaymentMethodCustomerView> createState() => _SelectPaymentMethodCustomerViewState();
}

class _SelectPaymentMethodCustomerViewState extends State<SelectPaymentMethodCustomerView> {
