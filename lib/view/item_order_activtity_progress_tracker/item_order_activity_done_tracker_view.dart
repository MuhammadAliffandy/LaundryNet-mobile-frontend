...
class ItemOrderActivityDoneTrackerView extends StatefulWidget {
  const ItemOrderActivityDoneTrackerView({
    super.key,
  });

  static const routeName = '/item-order-activity-done-tracker-screen';

  @override
  State<ItemOrderActivityDoneTrackerView> createState() => _ItemOrderActivityDoneTrackerViewState();
}

class _ItemOrderActivityDoneTrackerViewState extends State<ItemOrderActivityDoneTrackerView> {
