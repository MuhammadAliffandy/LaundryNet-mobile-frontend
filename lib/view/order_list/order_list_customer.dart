...
class OrderListCustomerView extends StatefulWidget {
  static const viewAsCustomer = '/order-list-customer-screen';

  const OrderListCustomerView({super.key});

  @override
  State<OrderListCustomerView> createState() => _OrderListCustomerViewState();
}

class _OrderListCustomerViewState extends State<OrderListCustomerView> {
  @override
