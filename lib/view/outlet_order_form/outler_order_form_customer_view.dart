...
class OutletOrderFormCustomerView extends StatefulWidget {
  static const viewAsCustomer = '/outlet-order-form-customer-screen';

  const OutletOrderFormCustomerView({super.key});

  @override
  State<OutletOrderFormCustomerView> createState() => _OutletOrderFormCustomerViewState();
}

class _OutletOrderFormCustomerViewState extends State<OutletOrderFormCustomerView> {
