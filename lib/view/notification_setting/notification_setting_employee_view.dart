...
class NotificationSettingEmployeeView extends StatefulWidget {
  static const viewAsEmployee = '/notification-setting-employee-screen';

  const NotificationSettingEmployeeView({super.key});

  @override
  State<NotificationSettingEmployeeView> createState() => _NotificationSettingEmployeeViewState();
}

class _NotificationSettingEmployeeViewState extends State<NotificationSettingEmployeeView> {
  @override
