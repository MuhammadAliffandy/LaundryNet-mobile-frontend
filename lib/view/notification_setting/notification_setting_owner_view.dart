...
class NotificationSettingOwnerView extends StatefulWidget {
  static const viewAsOwner = '/notification-setting-owner-screen';

  const NotificationSettingOwnerView({super.key});

  @override
  State<NotificationSettingOwnerView> createState() => _NotificationSettingOwnerViewState();
}

class _NotificationSettingOwnerViewState extends State<NotificationSettingOwnerView> {
  @override
